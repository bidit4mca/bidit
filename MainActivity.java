...
public class MainActivity extends AppCompatActivity {
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS " + SQLiteHelper.TABLE_NAME + "(" + SQLiteHelper.Table_Column_ID + " , " + SQLiteHelper.Table_Column_1_Name + " VARCHAR, " + SQLiteHelper.Table_Column_2_Email + " VARCHAR, "+ SQLiteHelper.Table_Column_3_Age + " INTEGER, " + SQLiteHelper.Table_Column_4_Password + " VARCHAR);");
