...
public class Registrationform extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if((EditTextEmptyHolder == true)&&(f)&&(g))
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO "+SQLiteHelper.TABLE_NAME+" (name,age,gender,phoneno,email,username,password) VALUES('"+Name+"', '"+Age+"','"+Gender+"','"+Phoneno+"','"+Email+"','"+Username+"', '"+Password+"');";
